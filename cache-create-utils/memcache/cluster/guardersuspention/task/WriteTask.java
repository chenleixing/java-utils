  ...
  implements ITask
{
  ...
  public WriteTask(List<Server> clientList, String key, Object value)
  {
  ...
  public void excuse()
  {
    for (int i = 0; i < this.clientList.size(); ) {
      try {
        if (((Server)this.clientList.get(i)).getMemcachedClient().put(this.key, this.value)) break label117;
